    ...
    public class DanhSachNguoiDungNgungHoatDongController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                {
                    model.lstDisplay = userDao.getAllUsersDeActiveByQuanLy();
                }
        ...
        public ActionResult Index(DanhSachNguoiDungHoatDongModel model)
        {
            try
            {
                ...
                if (currentRole == roleQuanLy)
                {
                    model.lstDisplay = userDao.getAllUsersDeActiveByQuanLy(model.nameSearch, model.roleIdSearch, model.fromDate, model.toDate);
        ...
        public JsonResult autoCompleteNameSearch(string searchValue)
        {
            ...
            var lstAll = dao.getAllUsersDeActiveByQuanLy(searchValue);
