...
namespace ThaiSonBacDMS.Areas.QuanTri.Controllers
{
    ...
    {
        // GET: QuanTri/DanhSachNguoiDungHoatDong
        public ActionResult Index()
        {
            try
            {
                ...
                {
                    model.lstDisplay = userDao.getAllUsersActiveByQuanTri();
                }
        ...
        public ActionResult Index(DanhSachNguoiDungHoatDongModel model)
        {
            try
            {
                ...
                if (currentRole == roleQuanTri)
                {
                    model.lstDisplay = userDao.getAllUsersActiveByQuanTri(model.nameSearch, model.roleIdSearch, model.fromDate, model.toDate);
        ...
        public JsonResult autoCompleteNameSearch(string searchValue)
        {
                ...
                var lstAll = dao.getAllUsersActiveByQuanTri(searchValue);
