...
namespace ThaiSonBacDMS.Areas.QuanLy.Controllers.Tests
{
    ...
    public class GiaSanPhamControllerTest
    {
        ...
        public void IndexTest()
        {
            ...
            var x = result.Model as GiaSanPhamModel;
        ...
        //search by price from is character
        [TestMethod()]
        public void SearchBy_From_Price_Is_Character()
        {
            var controller = new GiaSanPhamController();
            var model = new GiaSanPhamModel();
            model.VAT = "1";
        ...
        //search by price from is negative
        [TestMethod()]
        public void SearchBy_From_Price_Is_Negative()
        {
            var controller = new GiaSanPhamController();
            var model = new GiaSanPhamModel();
            model.VAT = "1";
            model.priceFrom = "-5,666";
            var result = controller.Index(model) as ViewResult;
            var x = result.Model as GiaSanPhamModel;
            Assert.IsTrue(x.map.Count > 0);
        }
